...
import 'package:stunting/pages/quiz/posttestesai.dart';
...
class PostestEsaiMenu extends StatefulWidget {
  const PostestEsaiMenu({Key? key}) : super(key: key);

  @override
  State<PostestEsaiMenu> createState() => _PostestEsaiMenuState();
}

class _PostestEsaiMenuState extends State<PostestEsaiMenu> {
                    ...
                    EndOfMateri(
                      ...
                      press: () async {
                        ...
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const PostestEsai(),
                          ),
                        );
                      },
                    )
