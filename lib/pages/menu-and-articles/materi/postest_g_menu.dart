...
class PostestGMenu extends StatefulWidget {
  const PostestGMenu({Key? key}) : super(key: key);

  @override
  State<PostestGMenu> createState() => _PostestGMenuState();
}

class _PostestGMenuState extends State<PostestGMenu> {
                    ...
                    EndOfMateri(
                      ...
                      press: () async {
                        ...
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const PostestG(),
                          ),
                        );
                      },
                    )
